                        ...
                        <div className='flex items-center justify-between flex-1 min-w-0'>
                          <div className='text-base font-medium truncate' title={skillBase}>
                            <Select
                              ...
                              <SelectTrigger className='px-1 py-0.5 text-sm text-white bg-gray-800 border-none rounded'>
                                <SelectValue placeholder={`-- ${t("amulet.selectSkill", "選擇技能")} --`}>
                                  {selected ? t(`skillTranslations.${selected}`, selected) : null}
                                </SelectValue>
                              </SelectTrigger>
                              <SelectContent side='bottom' position='popper' align='start' avoidCollisions={false}>
                                <SelectGroup>
                                  <SelectLabel>
        ...
        <div className='mt-5 text-2xl font-bold '>
          {(() => {
            ...
            return (
              <>
                <div>
                  {t("common.probability", "機率")}:{`${formatted}% (1/${oddsDisplay})`}
                </div>
              </>
            )
          })()}
      ...
      <div className='flex items-start gap-4 mx-auto lg:ml-10 '>
        <div className='flex flex-col '>
          ...
          <div className='mb-2 text-base'>
            <span className='font-medium'>{t("amulet.skillGroups", "技能群組")}:</span>
          </div>
                ...
                return (
                  <div key={si} className='inline-flex items-center gap-2'>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      {slotProb != null ? <span className='text-sm text-gray-400'>({(Number(slotProb) * 100).toFixed(2)}%)</span> : null}
                    </div>
                  </div>
                )
              })
