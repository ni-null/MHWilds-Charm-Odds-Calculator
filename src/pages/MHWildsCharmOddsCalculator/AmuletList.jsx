...
export default function AmuletList() {
  ...
  // Make this component self-contained: compute skill->group map, virtual amulets,
  // matchingAmulets, probability calculations and helper getGroupSkillCountForRarity
  ...
  // build virtual amulet list from rarityBaseProbability (same shape used elsewhere)
